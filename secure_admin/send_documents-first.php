...
// $msgTo = $email;
			...
			$message .= "<p></p>";
			$message .= "<a href='indiastudyabroad.org/documents/2nd_inst/Glimpse-CultureShock.pdf' target='_blank'>Glimpse-CultureShock.pdf</a>";
			$message .= "<p></p>";
			$message .= "<a href='indiastudyabroad.org/documents/2nd_inst/Pre-Departure Handbook v1.2.pdf' target='_blank'>Pre-Departure Handbook</a>";
			
			//$message .= "<a href='indiastudyabroad.org/documents/2nd_inst/ISAC_handbook.doc' target='_blank'>ISAC_handbook.doc</a>";
			//$message .= "<p></p>";
			//$message .= "<a href='http://indiastudyabroad.org/documents/2nd_inst/PROGRAM_GUIDE-pre_departure.doc' target='_blank'>PROGRAM_GUIDE -pre_departure.doc</a>";
			$message .= "<p></p>";
			$message .= "<p></p>";
			$message .= "<p></p>";
$message .= "Sincerely,";
...
//            
	// html mailer
$sql = "UPDATE application SET doc_1 = '1' WHERE formid = '$formid' AND isacid = '$isacid'";
$result = mysqlquery($sql);
if($result)
{
	header('location:view_admin_dashboard.php');
