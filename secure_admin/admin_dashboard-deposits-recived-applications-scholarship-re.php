...
// How many adjacent pages should be shown on each side?
	...
	*/
	$query = "SELECT COUNT(*) as num FROM $tbl_name WHERE registration_fee = 'PAID' AND fee_first_installment = '' AND fee_second_installment = '' AND user_type = 'SCHOLARSHIP' ORDER BY id DESC";
	$total_pages = mysqli_fetch_array(mysqlquery($query));
	$total_pages = $total_pages["num"];
	
	/* Setup vars for query. */
	$targetpage = "admin_dashboard-deposits-recived-applications-scholarship-re.php"; 	//your file name  (the name of this file)
	...
	/* Get data. */
$sql = "SELECT * FROM $tbl_name WHERE  registration_fee = 'PAID' AND fee_first_installment = '' AND fee_second_installment = '' AND user_type = 'SCHOLARSHIP' ORDER BY id DESC LIMIT $start, $limit ";
...
<a href="admin_index.php"><img src="images/btn_dashboard.jpg" alt="Admin" width="150" height="26" border="0" class='btn_apply11' /></a>
 ...
 <div id="navigation">
        ...
        <li ><a href="admin_dashboard-registered-applications-group-re.php" title="Group Applications ">Group  </a></li>
        <li class="navigation1"><a href="admin_dashboard-registered-applications-scholarship-re.php" title="admin_dashboard-incomplete-applications-scholarship">Scholarship </a></li>
...
<img src="images/theme_register.jpg" width="990" height="350" alt="Programs" title="Programs" /></div --> 
  ...
  <div class="rht_tab">
  <ul>
  <li><a href="admin_dashboard-registered-applications-scholarship-re.php" title="Registered Applications">$45 DUE</a></li>
  <li>|</li>
  <li><a href="admin_dashboard-deposits-recived-applications-scholarship-re.php" title="Deposits Received"><strong>$300 DUE</strong></a>
  </li><li>|</li>
  <li><a href="admin_dashboard-fully-paid-applications-scholarship-re.php" title="Fully Paid">FINAL PAYMENT DUE</a>
  </li></ul>
  </div>
  <h1>Scholarship</h1>
  <!-- Right Links ends -->
