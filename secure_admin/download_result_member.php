...
$sql = "SELECT * FROM $DB_TBLName WHERE registration_fee = '' AND fee_first_installment = '' AND fee_second_installment = '' ORDER BY id DESC";
...
header("Content-Disposition: attachment; filename=ISAC_MEMBERS.$file_ending");
