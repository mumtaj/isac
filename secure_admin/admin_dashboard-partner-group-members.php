<?php
    ...
    if ( empty($_POST['group_id']) ) $_POST['group_id'] = "";
    if ( empty($_POST['partner_id']) ) $_POST['partner_id'] = "";
            ...
            <td>
            	<form action="admin_dashboard-partner-group-invoice-sent.php" method="post" onsubmit="return confirm('Are you sure you want to Save?')">
                    <select name="invoice_status" id="invoice_status" class="dropdown_g" >
						...
						?>
                        <option value="Pending" <?php if ( isset($flag) ) echo $flag; ?>>Pending</option>
                        <option value="Invoice Sent" <?php if ( isset($flag1) ) echo $flag1; ?>>Invoice Sent</option>
                        <option value="Paid" <?php if ( isset($flag2) ) echo $flag2; ?>>Paid</option>
                    </select>
