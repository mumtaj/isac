<?php
	...
	*/
	$query = "SELECT COUNT(*) as num FROM $tbl_name WHERE fee_first_installment = '' AND registration_fee = 'PAID' AND user_type = 'PARTNER' ORDER BY id DESC";
	$total_pages = mysqli_fetch_array(mysqlquery($query));
	$total_pages = $total_pages["num"];
	
	/* Setup vars for query. */
	$targetpage = "admin_dashboard-deposits-recived-applications-partners-re.php"; 	//your file name  (the name of this file)
	...
	/* Get data. */
$sql = "SELECT * FROM $tbl_name WHERE fee_first_installment = '' AND registration_fee = 'PAID' AND user_type = 'PARTNER' ORDER BY id DESC LIMIT $start, $limit ";
...
<img src="images/theme_register.jpg" width="990" height="350" alt="Programs" title="Programs" /></div --> 
  ...
  <li>|</li>
  <li><a href="admin_dashboard-deposits-recived-applications-partners-re.php" title="Deposits Received"><strong>$300 DUE</strong></a>
  </li><li>|</li>
