...
// How many adjacent pages should be shown on each side?
	...
	*/
	...
	$targetpage = "admin_dashboard.php"; 	//your file name  (the name of this file)
...
<div id="wrapper"> 
 ...
 <div id="navigation">
              <ul>
        <li><a href="#" title="Individual Applications">Individual Applications</a></li>
        <li><a href="#" title="Group Applications ">Group Applications </a></li>
...
<img src="images/theme_register.jpg" width="990" height="350" alt="Programs" title="Programs" /></div --> 
  ...
  <div class="rht_tab">
  <ul>
  <li  class="newSelect"><a href="#" title="Incomplete Applications">Incomplete Applications</a></li>
  <li>|</li>
  <li><a href="#" title="Registered Applications">Registered Applications</a></li>
  <li>|</li>
  <li><a href="#" title="Deposits Recieved">Deposits Recieved</a></li>
  <li>|</li>
  <li><a href="#" title="Fully Paid">Fully Paid</a></li>
  </ul>
  </div>
  <!-- Right Links ends -->
