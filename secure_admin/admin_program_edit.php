...
<?php 
    ...
    $pr_id = $_POST['edit_cat_id'];  
    $pr_edit = mysqlquery("SELECT * FROM isac_duration WHERE program_id = '$pr_id'");

  while ($row = mysqli_fetch_array($pr_edit))
  {
	 $start_week = $row['start_week'];
	 $end_week = $row['end_week'];  
	 $base_amount = $row['base_amount'];
	 $difference_amount = $row['difference_amount'];
	  $base_amount1 = $row['base_amount_gp'];
	 $difference_amount1 = $row['difference_amount_gp'];
	  $base_amount2 = $row['base_amount_sc'];
	 $difference_amount2 = $row['difference_amount_sc'];
	  $base_amount3 = $row['base_amount_part'];
	 $difference_amount3 = $row['difference_amount_part'];
	  
  }
?>
<?php
 $sel_cat = mysqlquery("SELECT * FROM category WHERE cat_id = '$pr_id'");
  while ($row1 = mysqli_fetch_array($sel_cat))
  {
 ...
 <div class="main_program1">
   <div class="main_program_inside1">
    <table width="745" border="0" class="admin_tbl" cellspacing="0" cellpadding="0">
     <form method="post" action="prog_update.php" name="form_prog" id="form_prog">
      <tr>
        <td colspan="2" class="link brn_n"><strong>Edit Program</strong></td>
        </tr>
      <tr>
    <td width="363">Program Name</td>
    <td width="380" class="link brn_n"><input type="hidden" name="prog_id" value="<?php echo $cat_id; ?>" /><input type="text" value="<?php echo $category_name; ?>" name="program" size="40" /></td>
  </tr>
  <tr>
    <td>Enter Start week</td>
    <td class="link brn_n"><input type="text" name="start_week" size="15" id="start_week" value="<?php echo $start_week; ?>"  /></td>
  </tr>
  <tr>
    <td>Enter End week</td>
    <td class="link brn_n"><input type="text" name="end_week" size="15" value="<?php echo $end_week; ?>"  /></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="link brn_n"><input type="text" name="base_amount" size="15" value="<?php echo $base_amount; ?>"  /></td>
  </tr>
  <tr>
    <td>Enter additional week cost</td>
    <td class="link brn_n"><input type="text" name="difference_amount" size="15" value="<?php echo $difference_amount; ?>"  /></td>
  </tr>
  <tr>
  ...
  <tr>
    <td>Enter Program cost</td>
    <td class="link brn_n"><input type="text" name="base_amount1" size="15" value="<?php echo $base_amount1; ?>"  /></td>
  </tr>
  <tr>
    <td>Enter additional week cost</td>
    <td class="link brn_n"><input type="text" name="difference_amount1" size="15"  value="<?php echo $difference_amount1; ?>"  /></td>
  </tr>
  <tr>
  ...
  <tr>
    <td>Enter Program cost</td>
    <td class="link brn_n"><input type="text" name="base_amount2" size="15"  value="<?php echo $base_amount2; ?>"  /></td>
  </tr>
  <tr>
    <td>Enter additional week cost</td>
    <td class="link brn_n"><input type="text" name="difference_amount2" size="15" value="<?php echo $difference_amount2; ?>" /></td>
  </tr>
  <tr>
  ...
  <tr>
    <td>Enter Program cost</td>
    <td class="link brn_n"><input type="text" name="base_amount3" size="15"  value="<?php echo $base_amount3; ?>"  /></td>
  </tr>
  <tr>
    <td>Enter additional week cost</td>
    <td class="link brn_n"><input type="text" name="difference_amount3" size="15" value="<?php echo $difference_amount3; ?>" /></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
