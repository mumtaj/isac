...
$sql = "SELECT * FROM $DB_TBLName WHERE registration_fee = 'PAID' AND fee_first_installment = '' AND fee_second_installment = '' ORDER BY id DESC";
...
header("Content-Disposition: attachment; filename=ISAC_APPLICANT.$file_ending");
