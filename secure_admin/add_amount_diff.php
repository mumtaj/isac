...
$quer2 = mysqlquery("SELECT * FROM category order by cat_id"); 
//$tbl_name="category";	
...
<div id="wrapper"> 
  ...
  <div class="header"> 
    ...
    <div id="navigation">
      <ul>
        <li><a href="admin_dashboard.php" title="About">Admin Dashboard</a></li>
        <li><a href="admin_currency.php" title="About">Currency</a></li>
        <li><a href="admin_program.php" title="programs">Add Program</a></li>
      </ul>
    </div> 
...
while($prog = mysqli_fetch_array($quer2)) { 
