...
$sql = "SELECT * FROM $DB_TBLName WHERE registration_fee = 'PAID' AND fee_first_installment = 'PAID' AND fee_second_installment = '' AND final_reminder = '3' ORDER BY id DESC";
...
header("Content-Disposition: attachment; filename=ISAC_DEFAULTER.$file_ending");
