...
<form method="post" action="prog_update_dates_action.php" name="form_prog">
<tr>
...
<input type="hidden" name="cat_id"  value="<?php echo $cat_id; ?>"/>
 ...
 <td><input type="text" name="start_week" size="3" value="<?php echo $start_week;  ?>" /></td>
 
 <td><input type="text" name="end_week" size="3" value="<?php  echo $end_week; ?>" /> </td>
 
 <td><input type="text" name="base_amount" size="3" value="<?php echo $base_amount; ?>" /></td>
 
 <td><input type="text" name="difference_amount" size="3" value="<?php echo $difference_amount; ?>" /> </td>
   <td class="link brn_n">
