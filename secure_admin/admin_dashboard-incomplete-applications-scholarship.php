...
// How many adjacent pages should be shown on each side?
	...
	*/
	$query = "SELECT COUNT(*) as num FROM $tbl_name WHERE registration_fee = '' AND user_type = 'SCHOLARSHIP' AND scholarship_status = 'APPROVED' ORDER BY id DESC";
	...
	/* Get data. */
$sql = "SELECT * FROM $tbl_name WHERE registration_fee = '' AND user_type = 'SCHOLARSHIP' AND scholarship_status = 'APPROVED' ORDER BY id DESC LIMIT $start, $limit ";
...
<img src="images/theme_register.jpg" width="990" height="350" alt="Programs" title="Programs" /></div --> 
  ...
  <li><a href="admin_dashboard-incomplete-applications-scholarship.php" title="Incomplete Applications"><strong>Incomplete Applications</strong></a></li>
  <li>|</li>
