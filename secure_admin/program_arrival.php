...
if ( ! isset( $_GET['pid']) )  $_GET['pid'] = "";
    ...
    $quer2=mysqlquery("SELECT * FROM category "); 
...
<th width="166" class="brn_n" style="text-align:center">EDIT </th>
 ...
 <?php
 $quer_sql=mysqlquery("SELECT * FROM isac_arrival_table WHERE program_id = '$q'"); 
	while($arrival = mysqli_fetch_array($quer_sql)) 
	{
...
$quer_sql1=mysqlquery("SELECT * FROM category WHERE cat_id = '$program_id'"); 	
