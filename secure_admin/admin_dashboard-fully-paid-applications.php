...
// How many adjacent pages should be shown on each side?
	...
	*/
	$query = "SELECT COUNT(*) as num FROM $tbl_name WHERE user_type = '' AND fee_second_installment = 'PAID' AND delete_flag = '' ORDER BY id DESC ";
	$total_pages = mysqli_fetch_array(mysqlquery($query));
	$total_pages = $total_pages["num"];
	
	/* Setup vars for query. */
	$targetpage = "admin_dashboard-fully-paid-applications.php"; 	//your file name  (the name of this file)
	...
	/* Get data. */
	$sql = "SELECT * FROM $tbl_name WHERE user_type = '' AND fee_second_installment = 'PAID' AND delete_flag = ''  ORDER BY id DESC  LIMIT $start, $limit ";
...
<img src="images/theme_register.jpg" width="990" height="350" alt="Programs" title="Programs" /></div --> 
  ...
  <li>|</li>
  <li><a href="admin_dashboard-fully-paid-applications.php" title="Fully Paid"><strong>Fully Paid</strong></a></li>
  </ul>
  </div>
   <h1>Individual</h1>
  <!-- Right Links ends -->
