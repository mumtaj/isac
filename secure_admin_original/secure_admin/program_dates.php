...
$sql_select_pr = "SELECT * FROM category ";
	$result_pr = mysql_query($sql_select_pr);
	while($feach_info_pr = mysql_fetch_array($result_pr))
	{
...
<?php
	...
	$query1=mysql_query("SELECT * FROM isac_duration"); 
	while($duration_iz = mysql_fetch_array($query1)) 
	{
...
$quer_sql1=mysql_query("SELECT * FROM category WHERE cat_id = '$program_id_iz'"); 	
