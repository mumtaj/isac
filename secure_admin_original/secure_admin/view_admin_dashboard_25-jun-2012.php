...
$reg_query = "SELECT * FROM registration WHERE isacid = '$isacid'";
$reg_result = mysql_query($reg_query);
$reg_row=mysql_fetch_array($reg_result);

$gender = $reg_row['gender'];
$date = $reg_row['date'];
$month = $reg_row['month'];
$year = $reg_row['year'];

$contact_home = $reg_row['phone_number'];
$contact_cell = $reg_row['phone_mobile'];
$skype = $reg_row['skype'];
...
$status = $reg_row['student_professional_status'];

$university = $reg_row['uni_name'];
$majoring_in = $reg_row['majoring_in'];
$educational = $reg_row['educational'];
		
$title =$reg_row['title'];
$year_of_study = $reg_row['year_of_study'];
$company = $reg_row['company'];
$academic_qualification = $reg_row['academic_qualification'];
$educational_qualifications = $reg_row['educational_qualifications'];
$previous_experience = $reg_row['previous_experience'];
$previous_experience_describe = $reg_row['previous_experience_describe'];
$visited_india = $reg_row['visited_india'];
$visited_india_locations = $reg_row['visited_india_locations'];
$purpose_of_visit = $reg_row['purpose_of_visit'];
$local_language = $reg_row['local_language'];
$registration_fee = $reg_row['registration_fee'];
$local_language_mention = $reg_row['local_language_mention'];
$interested_in_program = $reg_row['interested_in_program'];
$your_expectations = $reg_row['your_expectations'];
$about_ISAC = $reg_row['about_ISAC'];
			 

$flight_query = "SELECT * FROM arrival_flight WHERE formid = '$formid'";
$flight_result = mysql_query($flight_query);
while($flight_row = mysql_fetch_array($flight_result))
{
        ...
        <tr>
          <td><table width="780" border="0" cellspacing="2" cellpadding="2" class="top_spacing">
              ...
              <tr>
                ...
                <td valign="top" class="form_text"><?php echo $airline_name;?></td>
              </tr>
              <tr>
                <td colspan="3" valign="top"><img src="images/spacer.gif" width="1" height="3" /></td>
              </tr>
              <tr>
                ...
                <td valign="top" class="form_text"><?php echo $flight_number;?></td>
              </tr>
              <tr>
                <td colspan="3" valign="top"><img src="images/spacer.gif" width="1" height="3" /></td>
              </tr>
              <tr>
                ...
                <td valign="top" class="form_text"><?php echo $arrival_date;?></td>
              </tr>
               <tr>
                <td colspan="3" valign="top"><img src="images/spacer.gif" width="1" height="3" /></td>
              </tr>
              <tr>
                ...
                <td valign="top" class="form_text"><?php echo $arrival_time;?></td>
              </tr>
              <tr>
                <td colspan="2" class="form_text"><img src="images/spacer.gif" width="1" height="8" /></td>
              </tr>
              <tr>
                <td valign="top" class="form_text">Comments:</td>
                <td valign="top" class="form_text"><?php echo $comments;?></td>
              </tr>
              <tr>
                <td colspan="2" class="form_text"><img src="images/spacer.gif" width="1" height="8" /></td>
              </tr>
