...
// How many adjacent pages should be shown on each side?
	...
	*/
	$query = "SELECT COUNT(*) as num FROM $tbl_name WHERE registration_fee = 'PAID' AND fee_first_installment = 'PAID' AND fee_second_installment = ''";
	...
	/* Get data. */
	$sql = "SELECT * FROM $tbl_name WHERE registration_fee = 'PAID' AND fee_first_installment = 'PAID' AND fee_second_installment = '' ORDER BY id DESC LIMIT $start, $limit ";
...
<a href="admin_index.php"><img src="images/btn_dashboard.jpg" alt="Admin" width="150" height="26" border="0" class='btn_apply11' /></a>
 ...
 <div id="navigation">
        ...
        <li class="navigation1"><a href="admin_dashboard-candidate.php" title="admin_dashboard-candidate">Candidate</a></li>
...
<img src="images/theme_register.jpg" width="990" height="350" alt="Programs" title="Programs" /></div --> 
  ...
  <tr>
	...
	$query1 = "SELECT COUNT(*) as num FROM $tbl_name WHERE registration_fee = 'PAID' AND fee_first_installment = 'PAID' AND fee_second_installment = '' AND gender = 'Male'";
	$query2 = "SELECT COUNT(*) as num FROM $tbl_name WHERE registration_fee = 'PAID' AND fee_first_installment = 'PAID' AND fee_second_installment = ''  AND gender = 'Female'";
  ...
  <tr>
    <td colspan="2"><a href="download_result_member_2.php" target="_blank">DOWNLOAD EXCEL </a></td>
    </tr>
