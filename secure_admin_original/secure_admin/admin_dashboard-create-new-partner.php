...
<?php
	...
	$query = "SELECT * FROM registration WHERE partner_isac = 'PARTNER' ORDER BY id DESC";
...
<img src="images/theme_register.jpg" width="990" height="350" alt="Programs" title="Programs" /></div --> 
  ...
  <?php
		if ($_GET['status'] == 'false')
		{
            ...
            <div class="success_reg">
            	 <h4 align="center" class="error">
                    ...
                    Please Check Partner Name Or Email.
                </h4>
            </div>
            <?php
		}
		...
		else if ($_GET['status'] == 'update_false')
		{
			?>
            <div class="success_reg">
            	<h4 align="center" class="error">
                   	Edit Partner Failed!<br /> <br />
                    Please Check Partner Name Or Email.
                </h4>
            </div>
           	<?php
		}
		else if ($_GET['status'] == 'update_true')
		{
			?>
            <div class="success_reg">
            	<h4 align="center" class="error" style="color:#030">
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%">
    	<tr>
        	<td style="width:50%">
            	...
            	<form action="admin_dashboard-create-partner-process.php" method="post" name="admin_create_partner" id="admin_create_partner">
              <table width="100%" border="0" cellspacing="2" cellpadding="2" class="top_spacing">
        
                <tbody><tr>
                  <td width="164" class="form_text">Partner Name:</td>
                  <td colspan="2" class="space_for_form"><input type="text" name="partnername" id="partnername" class="text_field" title="Enter Partner Name"></td>
                </tr>
                <tr>
                  <td></td>
                ...
                <tr>
                  ...
                  <td width="321" class="space_for_form_2">
                      <input type="text" name="email" class="text_field" title="Enter Email" id="email">
                  </td>
                </tr>
                <tr>
                  <td></td>
                ...
                <tr>
                  ...
                  <td colspan="2" class="space_for_form_2"><input type="text" name="details" class="text_area" title="Details"></td>
                </tr>
            ...
            <td style="width:48%; padding-left:20px;">
            	<h1>Existing Accounts</h1>
                 ...
                 <table width="400" border="0" cellspacing="0" cellpadding="0" class="admin_tbl">
                  <tbody><tr>
                    <th width="106" style="text-align:center">Name</th>
                    <th width="106" style="text-align:center">User Name</th>
				...
				?>
                        ...
                        <tr>
                    <td width="106" style="text-align:center"><?php echo $row['isac_partnername']; ?></td>
                    <td width="106" style="text-align:center"><?php echo $row['email']; ?></td>
                    <td width="106" style="text-align:center">
                        <form action="admin_dashboard-edit-partner.php" method="post">
                            <input type="hidden" value="<?php echo $row['isacid']; ?>" name="isacid" />
                            <input type="hidden" value="<?php echo $row['partner_id_isac']; ?>" name="partner_id" />
