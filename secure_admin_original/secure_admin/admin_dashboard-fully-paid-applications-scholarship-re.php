...
// How many adjacent pages should be shown on each side?
	...
	*/
	$query = "SELECT COUNT(*) as num FROM $tbl_name WHERE fee_first_installment = 'PAID' AND fee_second_installment = '' AND user_type = 'SCHOLARSHIP' ORDER BY id DESC";
	$total_pages = mysql_fetch_array(mysql_query($query));
	$total_pages = $total_pages[num];
	
	/* Setup vars for query. */
	$targetpage = "admin_dashboard-fully-paid-applications-scholarship-re.php"; 	//your file name  (the name of this file)
	...
	/* Get data. */
$sql = "SELECT * FROM $tbl_name WHERE fee_first_installment = 'PAID' AND fee_second_installment = '' AND user_type = 'SCHOLARSHIP' ORDER BY id DESC LIMIT $start, $limit ";
...
<img src="images/theme_register.jpg" width="990" height="350" alt="Programs" title="Programs" /></div --> 
  ...
  <li><a href="admin_dashboard-fully-paid-applications-scholarship-re.php" title="Fully Paid"><strong>FINAL PAYMENT DUE</strong></a>
  </li></ul>
  </div>
  <h1>Scholarship</h1>
  <!-- Right Links ends -->
