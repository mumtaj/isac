...
// How many adjacent pages should be shown on each side?
	...
	*/
	$query = "SELECT COUNT(*) as num FROM $tbl_name WHERE registration_fee = '' AND fee_first_installment = '' AND fee_second_installment = '' AND first_reminder = '5'";
	...
	/* Get data. */
	$sql = "SELECT * FROM $tbl_name WHERE registration_fee = '' AND fee_first_installment = '' AND fee_second_installment = ''   AND first_reminder = '5' ORDER BY id DESC LIMIT $start, $limit ";
...
<a href="admin_index.php"><img src="images/btn_dashboard.jpg" alt="Admin" width="150" height="26" border="0" class='btn_apply11' /></a>
 ...
 <div id="navigation">
        ...
        <li class="navigation1"><a href="admin_dashboard-prospect.php" title="">Prospect</a></li>
        <li><a href="admin_dashboard-defaulter.php" title="">Defaulter</a></li>
      </ul>
            </div> 
...
<img src="images/theme_register.jpg" width="990" height="350" alt="Programs" title="Programs" /></div --> 
  ...
  <!-- Right links starts here --><!-- Right Links ends -->
    <h1>prospect</h1>
    (Registered but $45 not paid after 5 reminders)
  ...
  <tr>
	...
	$query1 = "SELECT COUNT(*) as num FROM $tbl_name WHERE registration_fee = '' AND fee_first_installment = '' AND fee_second_installment = '' AND gender = 'Male' AND first_reminder = '5'";
	$query2 = "SELECT COUNT(*) as num FROM $tbl_name WHERE registration_fee = '' AND fee_first_installment = '' AND fee_second_installment = ''  AND gender = 'Female' AND first_reminder = '5'";
	$total_stu = mysql_fetch_array(mysql_query($query));
  ...
  <tr>
    <td>MALE:</td>
    <td class="brn_n"><?php $total_stu_m = mysql_fetch_array(mysql_query($query1));
  ...
  <tr>
    <td>FEMALE:</td>
    <td class="brn_n"><?php $total_stu_fm = mysql_fetch_array(mysql_query($query2));

	echo $total_st_dis_fm = $total_stu_fm[num]; 
	?></td>
  </tr>
  <tr>
    <td colspan="2"><a href="download_result_member_4.php" target="_blank">DOWNLOAD EXCEL </a></td>
    </tr>
