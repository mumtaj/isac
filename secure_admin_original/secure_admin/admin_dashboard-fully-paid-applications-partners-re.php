...
// How many adjacent pages should be shown on each side?
	...
	*/
	$query = "SELECT COUNT(*) as num FROM $tbl_name WHERE  fee_second_installment = '' AND fee_first_installment = 'PAID' AND user_type = 'PARTNER' ORDER BY id DESC";
	$total_pages = mysql_fetch_array(mysql_query($query));
	$total_pages = $total_pages[num];
	
	/* Setup vars for query. */
	$targetpage = "admin_dashboard-fully-paid-applications-partners-re.php"; 	//your file name  (the name of this file)
	...
	/* Get data. */
$sql = "SELECT * FROM $tbl_name WHERE fee_second_installment = '' AND fee_first_installment = 'PAID' AND user_type = 'PARTNER' ORDER BY id DESC LIMIT $start, $limit ";
...
<img src="images/theme_register.jpg" width="990" height="350" alt="Programs" title="Programs" /></div --> 
  ...
  <div class="rht_tab">
  <ul>
  <li><a href="admin_dashboard-registered-applications-partners-re.php" title="Registered Applications">$45 DUE</a></li>
  <li>|</li>
  <li><a href="admin_dashboard-deposits-recived-applications-partners-re.php" title="Deposits Received">$300 DUE</a>
  </li><li>|</li>
  <li><a href="admin_dashboard-fully-paid-applications-partners-re.php" title="Fully Paid"><strong>FINAL PAYMENT DUE</strong></a>
  </li></ul>
  </div>
  <h1>Partners</h1>
