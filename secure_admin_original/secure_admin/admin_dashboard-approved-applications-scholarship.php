...
// How many adjacent pages should be shown on each side?
	...
	*/
	$query = "SELECT COUNT(*) as num FROM $tbl_name WHERE scholarship_status = 'APPROVED' AND user_type = 'SCHOLARSHIP' ORDER BY id DESC";
	...
	/* Get data. */
$sql = "SELECT * FROM $tbl_name WHERE scholarship_status = 'APPROVED' AND user_type = 'SCHOLARSHIP' ORDER BY id DESC LIMIT $start, $limit ";
...
<img src="images/theme_register.jpg" width="990" height="350" alt="Programs" title="Programs" /></div --> 
  ...
  <div class="left_btns">
    ...
    <a href="admin_dashboard-approved-applications-scholarship.php" title="Approved Scholarship Applications"><img src="images/btn_approved_act.png" /></a>&nbsp;&nbsp;
    <a href="admin_dashboard-denied-applications-scholarship.php" title="Denied Scholarship Applications"><img src="images/btn_denied_deact.png" /></a>
  </div>
