...
// How many adjacent pages should be shown on each side?
	...
	*/
	$query = "SELECT COUNT(*) as num FROM $tbl_name WHERE user_type = 'PARTNER' AND registration_fee = 'PAID' AND fee_first_installment = '' AND fee_second_installment = ''";
	$total_pages = mysql_fetch_array(mysql_query($query));
	$total_pages = $total_pages[num];
	
	/* Setup vars for query. */
	$targetpage = "admin_dashboard-registered-applications-partners.php"; 	//your file name  (the name of this file)
	...
	/* Get data. */
	$sql = "SELECT * FROM $tbl_name WHERE user_type = 'PARTNER' AND registration_fee = 'PAID' AND fee_first_installment = '' AND fee_second_installment = '' ORDER BY id DESC LIMIT $start, $limit ";
...
<img src="images/theme_register.jpg" width="990" height="350" alt="Programs" title="Programs" /></div --> 
  ...
  <div class="rht_tab">
  <ul>
  <li><a href="admin_dashboard-incomplete-applications-partners.php" title="Incomplete Applications">Incomplete Applications</a></li>
  <li>|</li>
  <li><a href="admin_dashboard-registered-applications-partners.php" title="Registered Applications"><strong>Registered Applications</strong></a></li>
  <li>|</li>
  <li><a href="admin_dashboard-deposits-recived-applications-partners.php" title="Deposits Received">Deposits Received</a></li>
  <li>|</li>
  <li><a href="admin_dashboard-fully-paid-applications-partners.php" title="Fully Paid">Fully Paid</a></li>
  </ul>
  </div>
  <h1>Partners</h1>
  <!-- Right Links ends -->
