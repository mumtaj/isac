...
// How many adjacent pages should be shown on each side?
	...
	*/
	...
	$targetpage = "admin_dashboard-deposits-recived-applications-partners.php"; 	//your file name  (the name of this file)
	...
	/* Get data. */
$sql = "SELECT * FROM $tbl_name WHERE fee_first_installment = 'PAID' AND fee_second_installment = '' AND user_type = 'PARTNER' ORDER BY id DESC LIMIT $start, $limit ";
...
<img src="images/theme_register.jpg" width="990" height="350" alt="Programs" title="Programs" /></div --> 
  ...
  <li>|</li>
  <li><a href="admin_dashboard-registered-applications-partners.php" title="Registered Applications">Registered Applications</a></li>
  <li>|</li>
  <li><a href="admin_dashboard-deposits-recived-applications-partners.php" title="Deposits Received"><strong>Deposits Received</strong></a></li>
  <li>|</li>
