...
// How many adjacent pages should be shown on each side?
	...
	*/
	$query = "SELECT COUNT(*) as num FROM $tbl_name WHERE user_type = 'PARTNER' AND registration_fee = '' AND fee_first_installment = '' AND fee_second_installment = ''";
	$total_pages = mysql_fetch_array(mysql_query($query));
	$total_pages = $total_pages[num];
	
	/* Setup vars for query. */
	$targetpage = "admin_dashboard-registered-applications-partners-re.php"; 	//your file name  (the name of this file)
	...
	/* Get data. */
	$sql = "SELECT * FROM $tbl_name WHERE user_type = 'PARTNER' AND registration_fee = '' AND fee_first_installment = '' AND fee_second_installment = '' ORDER BY id DESC LIMIT $start, $limit ";
...
<a href="admin_index.php"><img src="images/btn_dashboard.jpg" alt="Admin" width="150" height="26" border="0" class='btn_apply11' /></a>
 ...
 <div id="navigation">
        ...
        <li class="navigation1"><a href="admin_dashboard-registered-applications-partners-re.php" title="admin_dashboard-incomplete-applications-partners">Partner </a></li>
      </ul>
            </div> 
...
<img src="images/theme_register.jpg" width="990" height="350" alt="Programs" title="Programs" /></div --> 
  ...
  <div class="rht_tab">
  <ul>
  <li><a href="admin_dashboard-registered-applications-partners-re.php" title="Registered Applications"><strong>$45 DUE</strong></a></li>
  <li>|</li>
  <li><a href="admin_dashboard-deposits-recived-applications-partners-re.php" title="Deposits Received">$300 DUE</a>
  </li><li>|</li>
  <li><a href="admin_dashboard-fully-paid-applications-partners-re.php" title="Fully Paid">FINAL PAYMENT DUE</a>
  </li></ul>
  </div>
  <h1>Partners</h1>
  <!-- Right Links ends -->
