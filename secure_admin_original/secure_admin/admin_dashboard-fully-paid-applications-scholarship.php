...
// How many adjacent pages should be shown on each side?
	...
	*/
	$query = "SELECT COUNT(*) as num FROM $tbl_name WHERE fee_second_installment = 'PAID' AND user_type = 'SCHOLARSHIP' AND scholarship_status = 'APPROVED' ORDER BY id DESC";
	$total_pages = mysql_fetch_array(mysql_query($query));
	$total_pages = $total_pages[num];
	
	/* Setup vars for query. */
	$targetpage = "admin_dashboard-fully-paid-applications-scholarship.php"; 	//your file name  (the name of this file)
	...
	/* Get data. */
$sql = "SELECT * FROM $tbl_name WHERE fee_second_installment = 'PAID' AND user_type = 'SCHOLARSHIP' AND scholarship_status = 'APPROVED' ORDER BY id DESC LIMIT $start, $limit ";
...
<img src="images/theme_register.jpg" width="990" height="350" alt="Programs" title="Programs" /></div --> 
  ...
  <li>|</li>
  <li><strong><a href="admin_dashboard-fully-paid-applications-scholarship.php" title="Fully Paid">Fully Paid</a></strong></li>
  </ul>
  </div>
  <h1>Scholarships</h1>
