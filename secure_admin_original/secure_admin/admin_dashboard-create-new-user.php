...
<a href="admin_index.php"><img src="images/btn_dashboard.jpg" alt="Admin" width="150" height="26" border="0" class='btn_apply11' /></a>
 ...
 <div id="navigation">
              <ul>
        <li class="navigation1"><a href="admin_dashboard-create-new-user.php" title="member">Create New User</a></li>
...
<img src="images/theme_register.jpg" width="990" height="350" alt="Programs" title="Programs" /></div --> 
  ...
  <!-- Right links starts here --><!-- Right Links ends -->
    ...
    <form action="admin_dashboard-create-user-process.php" method="post" name="admin_create_user" id="admin_create_user" >
      <table width="607" border="0" cellspacing="2" cellpadding="2" class="top_spacing">

        <tr>
          <td width="164" class="form_text">Name:</td>
          <td colspan="2" class="space_for_form"><input type="text" name="name" class="text_field" title="Enter Name" /></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td width="321" class="space_for_form_2">
          	<input type="text" name="usersname" id="usersname" class="text_field" title="Enter User Name" />
          </td>
...
var frmvalidator  = new Validator("admin_create_user");
var chktestValidator  = new Validator("admin_create_user");
