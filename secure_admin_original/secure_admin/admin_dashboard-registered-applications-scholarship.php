...
// How many adjacent pages should be shown on each side?
	...
	*/
	$query = "SELECT COUNT(*) as num FROM $tbl_name WHERE user_type = 'SCHOLARSHIP' AND registration_fee = 'PAID' AND fee_first_installment = '' AND fee_second_installment = '' AND scholarship_status = 'APPROVED'";
	$total_pages = mysql_fetch_array(mysql_query($query));
	$total_pages = $total_pages[num];
	
	/* Setup vars for query. */
	$targetpage = "admin_dashboard-registered-applications-scholarship.php"; 	//your file name  (the name of this file)
	...
	/* Get data. */
	$sql = "SELECT * FROM $tbl_name WHERE user_type = 'SCHOLARSHIP' AND registration_fee = 'PAID' AND fee_first_installment = '' AND fee_second_installment = '' AND scholarship_status = 'APPROVED' ORDER BY id DESC LIMIT $start, $limit ";
...
<img src="images/theme_register.jpg" width="990" height="350" alt="Programs" title="Programs" /></div --> 
  ...
  <li>|</li>
  <li><a href="admin_dashboard-registered-applications-scholarship.php" title="Registered Applications"><strong>Registered Applications</strong></a></li>
  <li>|</li>
