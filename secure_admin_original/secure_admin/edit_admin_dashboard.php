...
while($row=mysql_fetch_array($result))
 { 
		   ...
		   $title =$row['title'];
			...
			$previous_experience_describe = $row['previous_experience_describe'];
			$visited_india = $row['visited_india'];
			$visited_india_locations = $row['visited_india_locations'];
...
$program_result_my_pg = mysql_query($program_query_my_pg);
while($program_row_my_pg = mysql_fetch_array($program_result_my_pg))
{
	$cat_id_my_pg = $program_row_my_pg['cat_id'];
}
...
$program_start_result = mysql_query($program_start_query);
while($program_start_row = mysql_fetch_array($program_start_result))
{
