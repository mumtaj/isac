...
// How many adjacent pages should be shown on each side?
	...
	*/
	$query = "SELECT COUNT(*) as num FROM $tbl_name WHERE scholarship_status = 'PENDING' AND user_type = 'SCHOLARSHIP' ORDER BY id DESC";
	...
	/* Get data. */
$sql = "SELECT * FROM $tbl_name WHERE scholarship_status = 'PENDING' AND user_type = 'SCHOLARSHIP' ORDER BY id DESC LIMIT $start, $limit ";
...
<img src="images/theme_register.jpg" width="990" height="350" alt="Programs" title="Programs" /></div --> 
  ...
  <div class="left_btns">
  	<a href="admin_dashboard-pending-applications-scholarship.php" title="Pending Scholarship Applications"><img src="images/btn_pending_act.png" /></a>&nbsp;&nbsp;
