...
<div style="height:397px;width:940px;background-image:url(http://indiastudyabroad.org/images/themeBG.jpg);padding:12px">
...
<!-- /xs-read-more -->
 ...
 <h2>Testimonials</h2>
        ...
        <div > <p><?php the_excerpt(); ?>	</p></div>
  <a href="testimonials" title="<?php the_title(); ?>" class="link"> read more »</a>
<!-- /xs-read-more -->
