...
<div class="art-content-layout">
 ...
 <div class="left_sect reg lft">
    ...
    <div class="clear"></div>
    <form action="register_process.php" method="post" name="registerform"  >
    ...
    <td width="319"><input type="text" name="home" class="text_field"  title="Enter Cell Number"/></td>
  </tr>
    <tr>
    ...
    <tr>
      <td class="form_text" valign="top"><img src="images/spacer.gif" width="1" height="3" /></td>
