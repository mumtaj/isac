...
if(is_front_page()) { wp_head(); }
 ?>
<script src="<?php bloginfo('template_url'); ?>/js/jquery.min.js" type="text/javascript"></script>
<script type="text/javascript" src="<?php bloginfo('template_url'); ?>/js/script.js"></script>
<script type='text/javascript' src='http://indiastudyabroad.org/wp-includes/js/swfobject.js?ver=2.2-20120417'></script>
...
<!---Google analytics FH Digital---->

<script type="text/javascript">
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-32789570-1']);
...
<!---Google analytics ISAC---->
<script type="text/javascript">
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-27217547-1']);
  _gaq.push(['_trackPageview']);
