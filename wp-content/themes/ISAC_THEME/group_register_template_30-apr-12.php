...
<div class="art-content-layout">
 ...
 <div class="left_sect reg lft">
  ...
  <tr>
    ...
    <tr>
    <td valign="top" class="form_text">Name of University:</td>
    <td>
  ...
  <tr>
    ...
    <tr>
    <td valign="top" class="form_text">University contact number</td>
    <td>
    <input type="text" name="uni_contact" id="uni_contact" class="text_field" value="" />
        ...
        <tr>
          <td colspan="3" class="form_text"><label>
              ...
              I am the official representative of the University and agree with the <a href="terms.php" target="_blank">terms and conditions</a> mentioned </label></td>
        </tr>
        <tr>
