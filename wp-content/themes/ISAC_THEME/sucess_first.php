   ...
   if($refrence_no == $response['MerchantRefNo'])
   {
	   ...
	   <tr>
		...
		<?php
			...
			$status='PAID';
			mysql_query("UPDATE application SET fee_first_installment = '$status' WHERE formid = '$Order_Id'");
			...
			if($payment_group_id != '')
			{
				...
				$fee_first_inst_count = $row['fee_first_inst_count'] + 1;
				
				$update_sql = "UPDATE group_members_count SET fee_first_inst_count	= '$fee_first_inst_count' WHERE group_id = '$payment_group_id'";
			...
			$first_installment_amountinr = round(300*$changecur);
			...
			Thank you for your payment of USD 300 or INR $first_installment_amountinr.  <br />
