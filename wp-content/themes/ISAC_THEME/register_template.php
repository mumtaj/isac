...
<div class="art-content-layout marg_new_te">
    <div class="art-content-layout-row">
        <div class="art-layout-cell art-content">
        <!-- Start form --->
 <div class="left_sect reg lft width_hack">
   <h2 class="fonts_h2_headlines_forms">Registration form</h2>
    <p>All fields marked (<span style="color:#E91B03; font-weight:bold; font-family:'Courier New', Courier, monospace">*</span>) are mandatory.  
       </p>
    <div class="clear"></div>
    <form action="<?php bloginfo('template_url'); ?>/isac_process/register_process.php" method="post" name="registerform" id="registerform" >
      <table width="501" border="0" cellspacing="2" cellpadding="2" class="top_spacing">
        <tr>
        ...
        <tr>
          ...
          <td width="341" class="space_for_form_2">
        ...
        <tr>
    <td width="142" class="form_text text_aln_rt">Phone Home: </td>
    <td width="341"><input type="text" name="phone_home" class="text_field"  title="Enter Cell Number"/></td>
  </tr>
    <tr>
  ...
  <tr>
    ...
    <td class="space_for_form_2">&nbsp;</td>
  </tr>
  <tr>
    <td valign="top" class="form_text text_aln_rt">&nbsp;</td>
    <td class="space_for_form_2"><label>
              <input name="terms" type="checkbox" value="y" class="reg_checkbox" />
              I agree with the <a href="terms" target="_blank">terms and conditions</a> mentioned </label><span style="color:#E91B03; font-weight:bold; font-family:'Courier New', Courier, monospace">*</span>
             </td>
  </tr>
  <tr>
    <td colspan="2" valign="top"><img src="<?php bloginfo('template_url'); ?>/images/spacer.gif" width="1" height="8" /></td>
        ...
        <tr>
          <td colspan="3" class="form_text" style="text-align:center !important"></td>
        </tr>
        <tr>
          <td colspan="3" class="form_text"><img src="<?php bloginfo('template_url'); ?>/images/spacer.gif" width="1" height="8" /></td>
        </tr>
        <tr>
          <td colspan="3" class="form_text"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="text-align:center !important">
            <tr>
