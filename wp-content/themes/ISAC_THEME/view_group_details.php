...
<div class="art-content-layout">
  <div class="art-content-layout-row">
	...
	//////////////////NEXT PAY////////////////
	$formid_stu = $result_owner_gp['formid'];
		$reg_fee_stauts = $result_owner_gp['registration_fee'];
		$firstinstallement_status = $result_owner_gp['fee_first_installment'];        
		$secondinstallement_status = $result_owner_gp['fee_second_installment'];
		$due_installement_first = '300';
		$due_reg = '45';
		$final_payment = $result_owner_gp['second_installment'];
...
(In USD)</th>
          ...
          <tr>
            <td><?php echo $row_owner_gp['program'] ?></td>
            <td  width="75"><?php echo $row_owner_gp['duration'].' '.'Weeks' ?></td>
            <td ><?php echo $row_owner_gp['arrival'] ?></td>
            <td ><?php echo $row_owner_gp['firstname'] ?></td>
            <td ><?php echo $row_owner_gp['lastname'] ?></td>
            <td ><?php echo $row_owner_gp['email'] ?></td>
            <td width="65">$<?php echo $row_owner_gp['fee'] ?></td>
            
            
             <td  width="75">
            <?php echo $total_payment;   ?>
            </td>
            <td  width="75"><?php echo $total_due_next_installement;   ?></td>
            
            <td ><form action="<?php echo SERVER_URL;?>student_panel_dashboard_group_edit" method="post" onsubmit="return confirm('Are you sure you want to edit this record?')">
                ...
                <input type="image" src="<?php bloginfo('template_url'); ?>/images/icon_edit.png" value="EDIT" />
              </form></td>
            <td class="brn_n"><form action="<?php bloginfo('template_url'); ?>/isac_process/delete_to_group_process.php" method="post" onsubmit="return confirm('Are you sure you want to delete this record?')">
                <input type="hidden" value="<?php echo $row_owner_gp['formid'];?>" name="formid" />
                <input type="hidden" value="<?php echo $row_owner_gp['isacid'];?>" name="del_isacid" />
                <input type="hidden" value="<?php echo $group_id;?>" name="edit_groupid" />
                <input type="image" src="<?php bloginfo('template_url'); ?>/images/icon_delete.jpg" value="DELETE" />
              </form>
          </tr>
        </table>
        <?php
...
(In USD)</th>
		...
		elseif($reg_fee_stauts !='PAID' && $firstinstallement_status!='PAID' && $secondinstallement_status!='PAID')
		{
			...
			?>
          <tr>
            <td><?php echo $row_display_gp['program']; ?></td>
            <td width="75"><?php echo $row_display_gp['duration'].' '.'Weeks' ?></td>
            <td><?php echo $row_display_gp['arrival'] ?></td>
            <td><?php echo $row_display_gp['firstname'] ?></td>
            <td ><?php echo $row_display_gp['lastname'] ?></td>
            <td><?php echo $row_display_gp['email'] ?></td>
            <td width="65">$<?php echo $row_display_gp['fee'] ?></td>
