...
/* Template Name: payment_sucess_reg  */
...
$amountinr = $_SESSION['amountinr'].'.00'; // Our Amount
...
<div class="art-content-layout">
 ...
 <div class="left_sect reg" style="margin: 30px 0 30px 80px; width:700px ">
  <div class="top_spacing">
   ...
   <?php
//  echo $response['MerchantRefNo'];
 // echo '</br>';
 // echo $refrence_no;
 // echo '</br>';
 // echo $response['IsFlagged'];
  //  echo '</br>';
   	...
   	if($refrence_no == $response['MerchantRefNo'])
  	{
	   ...
	   <tr>
		...
		<?php
			...
			$status='PAID';
			mysql_query("UPDATE application SET registration_fee = '$status' WHERE formid = '$Order_Id'");
			...
			if($payment_group_id != '')
			{
				...
				$registration_fee_count = $row['registration_fee_count'] + 1;
				
				$update_sql = "UPDATE group_members_count SET registration_fee_count = '$registration_fee_count' WHERE group_id = '$payment_group_id'";
			...
			$registration_fee_amountinr = round(45*$changecur);
			...
			Thank you for your payment of USD 45 or INR $registration_fee_amountinr.  <br />
