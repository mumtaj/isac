...
/* Template Name: EDIT_personal_TEMPLATE */
...
<div class="art-content-layout">
 ...
 <div class="tmp_edit_area reg lft_nw1">
    ...
    <form action="<?php bloginfo('template_url'); ?>/isac_process/update_register_process.php" method="post" name="registerform" id="registerform" >
      <table width="607" border="0" cellspacing="2" cellpadding="2" class="top_spacing">
        <tr>
          <td width="164" class="form_text text_aln_rt">First Name:</td>
          <td colspan="2" class="space_for_form"><input type="text" name="firtsname"    class="text_field" title="Enter First Name" value="<?php echo $firstname; ?>" /></td>
        </tr>
        <tr>
          <td colspan="4"><img src="<?php bloginfo('template_url'); ?>/images/spacer.gif" width="1" height="3" /></td>
        </tr>
        <tr>
          <td class="form_text text_aln_rt">Last Name:</td>
          <td colspan="2" class="space_for_form_2"><input type="text" name="lastsname"  class="text_field" title="Enter Last Name" value="<?php echo $lastname; ?>" /></td>
        </tr>
        <tr>
          <td colspan="4"><img src="<?php bloginfo('template_url'); ?>/images/spacer.gif" width="1" height="3" /></td>
        </tr>
        <tr>
          <td class="form_text text_aln_rt">Email:<br />
            (username)</td>
          <td width="321" class="space_for_form_2"><?php echo $email; ?>
          <input type="hidden" name="email" class="text_field"  title="Enter Email" id="email" readonly  value="<?php echo $email; ?>" /></td>
          <td width="102" class="space_for_form_2"></td>
        </tr>
        <tr>
          <td colspan="4"><img src="<?php bloginfo('template_url'); ?>/images/spacer.gif" width="1" height="3" /></td>
        </tr>
        <tr>
          <td class="form_text text_aln_rt">Password:</td>
        ...
        <tr>
          <td class="form_text text_aln_rt">Confirm Password:</td>
        ...
        <tr>
          <td class="form_text text_aln_rt">Date of birth:</td>
        ...
        <tr>
          <td height="25" class="form_text text_aln_rt">Gender:</td>
        ...
        <tr>
    <td width="150" class="form_text text_aln_rt">Phone Number(HOME):</td>
    <td width="319"><input type="text" name="phone_home" class="text_field"  title="Enter Cell Number" value="<?php echo $phone_number; ?>"/></td>
  </tr>
    <tr>
    ...
    <tr>
      <td class="form_text text_aln_rt" valign="top">Phone Number(MOBILE):</td>
      <td><input type="text" name="cell" class="text_field" title="Enter Cell Number" value="<?php echo $phone_mobile; ?>"/></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><input type="text" name="skype" class="text_field"  value="<?php echo $skype; ?>" title="Enter Skype ID"/></td>
    </tr>
    <tr>
      <td class="form_text" valign="top"><img src="<?php bloginfo('template_url'); ?>/images/spacer.gif" width="1" height="3" /></td>
      <td><img src="<?php bloginfo('template_url'); ?>/images/spacer.gif" width="1" height="3" /></td>
    ...
    <tr>
    <td class="form_text text_aln_rt" valign="top">Address:</td>
    <td>
    <textarea name="address" id="description" cols="45" rows="4" class="text_field_input"><?php  echo $address; ?></textarea>
    </td>
  </tr>
    <tr>
        <td colspan="3"><img src="<?php bloginfo('template_url'); ?>/images/spacer.gif" width="1" height="3" /></td>
  ...
  <tr>
    <td valign="top" class="form_text text_aln_rt">Zip / Postal Code: </td>
    <td>
    <input type="text" name="zip" id="name" class="text_field" value="<?php echo $zip;  ?>" />
    </td>
  </tr>
    <tr>
        <td colspan="3"><img src="<?php bloginfo('template_url'); ?>/images/spacer.gif" width="1" height="3" /></td>
  ...
  <tr>
    <td valign="top" class="form_text text_aln_rt">City:</td>
    <td>
    <input type="text" name="city" id="name"  class="text_field" value="<?php echo $city;  ?>" />
    </td>
  </tr>
  <tr>
        <td colspan="3"><img src="<?php bloginfo('template_url'); ?>/images/spacer.gif" width="1" height="3" /></td>
  ...
  <tr>
    <td valign="top" class="form_text text_aln_rt">State:</td>
    <td>
    <input type="text" name="state" id="name" class="text_field" value="<?php echo $state; ?>"  />
    </td>
    </td>
      <tr>
        <td colspan="3"><img src="<?php bloginfo('template_url'); ?>/images/spacer.gif" width="1" height="3" /></td>
  ...
  <tr>
    <td valign="top" class="form_text text_aln_rt">Country:</td>
