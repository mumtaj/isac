 ...
 <div class="left_sect reg lft" style="margin-top:35px; margin-bottom:35px;">
  ...
  <tr>
    <td height="35" align="center">
      <span style="color:#F00; font-size:18px; text-align:center"><b>ACCESS DENIED</b>. <br />

		<b>Kindly Register/login to continue.</b></span><br /><br />

      <div class="btn_cent">
      	<a href="registration-option"><img src="<?php bloginfo('template_url'); ?>/images/btn_register.jpg" border="0"  /></a>
        &nbsp; &nbsp; <a href="student-login"><img src="<?php bloginfo('template_url'); ?>/images/btn_login.jpg" border="0"  /></a>
       </div>
    </td>
  </tr>
...
$.ajax({  //Make the Ajax Request
    type: "POST",  
    url: "<?php bloginfo('template_url'); ?>/isac_process/ajax_check_group_name.php",  //file name
...
<!--  <li>|</li>
  ...
  <li><a href="application" title="Apply a Program">Apply a Program</a></li>-->
        ...
        </div><h2 class="fonts_h2_headlines" style="width:900px">Create a Group</h2>
    <br />
    
    <br />

	<form action="<?php bloginfo('template_url'); ?>/isac_process/create_group_process.php" method="post" name="creategroupform" id="creategroupform" >
      <table width="607" border="0" cellspacing="2" cellpadding="2" class="top_spacing">
        <tr>
          <td width="178" class="form_text text_aln_rt" style="padding-right:14px !important">Enter Group Name:</td>
          <td width="307" class="space_for_form"><input type="text" name="groupname"  id="groupname" class="text_field" title="Enter Group Name" /></td>
        ...
        <tr>
         ...
         <tr>
          <td width="178" class="form_text">Minimum members per group:</td>
          <td class="form_text">
          	<?php
				$sql = 'SELECT * FROM group_limit';
				$result = mysql_query($sql);
				$row = mysql_fetch_array($result);
				echo '<b style="font-size:16px">'.$row['minimum'].'</b>';
			?>
        ...
        <tr>
         ...
         <tr>
          <td width="178" class="form_text">Maximum members per group:</td>
          <td class="form_text">
          	<?php
				echo '<b style="font-size:16px">'.$row['maximum'].'</b>';
			?>
